...
import org.firstinspires.ftc.teamcode.Kinkaid_Stuff.v3.UltronOpMode.AutonomousProgram;
import org.firstinspires.ftc.teamcode.Kinkaid_Stuff.v3.UltronRobot.General.Robot;
import org.firstinspires.ftc.teamcode.Kinkaid_Stuff.v3.UltronRobot.RobotSubSystems.CubeSystem;
import org.firstinspires.ftc.teamcode.Kinkaid_Stuff.v3.UltronRobot.RobotSubSystems.DogeCVSystem;
import org.firstinspires.ftc.teamcode.Kinkaid_Stuff.v3.UltronRobot.RobotSubSystems.DriveSystem;
import org.firstinspires.ftc.teamcode.Kinkaid_Stuff.v3.UltronRobot.RobotSubSystems.JewelArmSystem;
...
import org.firstinspires.ftc.teamcode.Kinkaid_Stuff.v3.UltronRobot.RobotSubSystems.SensorSystem;
...
import org.firstinspires.ftc.teamcode.Kinkaid_Stuff.v3.UltronRobot.UltronAutoRobot;
...
public abstract class UltronAuto extends AutonomousProgram {
    ...
    public DogeCVSystem dogeCVSystem;
//    public RelicSystem relicSystem;
    ...
    protected Robot buildRobot() {
        ...
        jewelArmSystem = (JewelArmSystem)ultron.getSubSystem("jewelArm");
        sensorSystem = (SensorSystem)ultron.getSubSystem("sensor");
        vuforiaSystem = (VuforiaSystem)ultron.getSubSystem("vuforia");
        dogeCVSystem = (DogeCVSystem)ultron.getSubSystem("dogeCV");
//        relicSystem = (RelicSystem)ultron.getSubSystem("relic");
        jewelColorSystem = (JewelColorSystem)ultron.getSubSystem("jewelColor");
        return ultron;
    }
    ...
    public JewelDetector.JewelOrder identifyJewelOrderVision(double time) {
        long startTime = System.currentTimeMillis();
        int sawRed_Blue = 0;
        int sawBlue_Red = 0;
        while (opModeIsActive() && (System.currentTimeMillis() < (startTime + time))) {
            JewelDetector.JewelOrder jewelOrder = dogeCVSystem.getCurrentOrder();
        ...
        if (sawRed_Blue > sawBlue_Red && sawRed_Blue > 0) {
            return JewelDetector.JewelOrder.RED_BLUE;
        } else if (sawBlue_Red > sawRed_Blue && sawBlue_Red > 0) {
            return JewelDetector.JewelOrder.BLUE_RED;
        } else {
            return JewelDetector.JewelOrder.UNKNOWN;
        }
    }
